    ...
    return (
        <div className="main">
            ...
            <div className="main-container">
                ...
                <div className="cards">
    <div className="card" onClick={() => setInput("Suggest some beautiful places to see on upcoming road trip")}>
        <p>Suggest some beautiful places to see on upcoming road trip</p>
